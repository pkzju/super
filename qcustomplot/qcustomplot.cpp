...
//  defaultAxisRect->insetLayout()->setMargins(QMargins(12, 12, 12, 12));
  ...
  mPlotLayout->addElement(0, 1, subLayout); // add sub-layout in the cell to the right of the main axis rect
  ...
  mPlotLayout->setColumnStretchFactor(1, 0.01);
  subLayout->setMargins(QMargins(13,13,13,13));
